...
function Navbar() {
  ...
  return (
    <>
      <div className="flex justify-between px-10 text-white py-4 items-center w-full ">
        <div>
      ...
      <div className="w-full h-1 bg-gradient-to-r mt-5  from-[#cf1b69] via-purple-900 to-[#106de6]"></div>
      {toggle && (
        <div className="fixed top-0 left-0 w-full h-90 z-50 sm:hidden backdrop-blur-md bg-white/10 text-pink-800 py-10 flex flex-col items-center justify-center">
          ...
          <RxCross2
            className="absolute top-5 right-5 text-3xl text-black cursor-pointer"
            onClick={toggleBtn}
          />
        </div>
      )}
